...
class ShadowView extends Component {
    ...
    render() {
      ...
      let shadowOpacityValue = (shadowOpacity !== undefined ? shadowOpacity : 0);
      if (typeof shadowOpacityValue == 'number' && Platform.OS == 'android') {
        shadowOpacityValue = shadowOpacityValue / 10;
      }
      return (
        <RNTShadowView
          {...this.props}
